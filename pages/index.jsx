...
import imgPalm from "../public/bibit-palm.webp"
  ...
  return (
    <Layout>
      <div className="relative">
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center bg-cover" >
          <section className="text-gray-600 body-font container">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
              <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                <Image className="object-cover object-center rounded" alt="hero" src={imgPalm} width={720} height={600}/>
              </div>
        ...
        <div className="sticky top-0 h-screen flex flex-col items-center justify-cente bg-gray-200 py-11">
