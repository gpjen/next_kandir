  ...
  return (
    <Layout title="Home">
      <div className="relative">
        <div className="hero1 backdrop-sepia-0 bg-white/30 relative shadow top-0 h-screen flex items-center justify-center" >
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-white">
                  Pengelolaan pabrik kelapa sawit terbesar yang terletak dimaluku tengah. Pengelolaan produksi terstruktur juga moderen dengen mengedepankan keberlangsungan linghungan dan sumber daya manusia. 
                </p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <Link href="/login">
                    <Button color="green" className="hover:shadow"> Masuk akun </Button>
                  </Link>
                  <a
                    href="#"
                    className="text-base font-semibold leading-7 text-white"
                  >
                    Cari hal lainny <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className=" hero2 shadow top-0 min-h-screen flex flex-col items-center justify-cente bg-white py-11">
